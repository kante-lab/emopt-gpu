...
g++ -c -fPIC Grid_CPP.cpp -fopenmp -O3 -march=native -DNDEBUG -std=c++14 -o Grid.o -I$EIGEN_DIR -I$BOOST_DIR -I/usr/lib/cuda/include/
echo "Linking Grid..."
g++ -shared -fopenmp -fPIC -o Grid.so Grid.o Grid_CUDA.o -lpthread -lrt -ldl -L/usr/lib/cuda/lib64 -lcudart_static -lculibos
